//runBeliefPropWithEstMotion.cpp
//Scott Grauer-Gray
//November 29, 2010
//Define the functions for running belief propagation

#include "runBeliefPropWithEstMotion.h"



//initialize running belief propagation with the desired parameters
runBeliefPropWithEstMotion::runBeliefPropWithEstMotion(int numBpLevels, int numBpItersPerLevel, float bpDataCostCap, float bpSmoothnessCostCap, float bpDataCostWeight,
...
resultMovement* runBeliefPropWithEstMotion::operator()(bpImage* bpImage1, bpImage* bpImage2, float* estMotionX, float* estMotionY)
{
...
currBeliefPropParams runBeliefPropWithEstMotion::genCurrBeliefPropParamsStruct()
{
...
resultMovement* runBeliefPropWithEstMotion::genResultMovementObject()
{
